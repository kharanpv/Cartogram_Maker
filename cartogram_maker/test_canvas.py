...
def on_plus_click(): #placeholder for future Plus button functionality
    
    print("[DEBUG]: Plus button pressed")

def on_minus_click(): #placeholder for future Minus button functionality
...
def main():
    ...
    plus_button = ctk.CTkButton(frame, text="+", command=on_plus_click, width=40, fg_color="lightgray", text_color="black",
                                 font=("Arial", 30), corner_radius=0, hover_color="lightgray")
    plus_button.grid(row=0, column=1, padx=(0, 5), pady=(0,50), sticky="se")

    minus_button = ctk.CTkButton(frame, text="-", command=on_minus_click, width=40, fg_color="lightgray", text_color="black",
                                 font=("Arial", 30), corner_radius=0, hover_color="lightgray")
